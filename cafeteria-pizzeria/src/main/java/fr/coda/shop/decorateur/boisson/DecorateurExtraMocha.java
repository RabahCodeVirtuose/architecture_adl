...
public final class DecorateurExtraMocha extends DecorateurProduit {
    private static final double PRIX = 1.00;

    public DecorateurExtraMocha(Produit produit) {
        super(produit);
    }
    ...
    public String obtenirDescription() {
        return produit.obtenirDescription() + " + extra mocha";
    }
}
